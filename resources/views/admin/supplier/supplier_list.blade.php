        ...
        <div class="home-tabs">
            <div class="home-tab-title">
                <div class="home-tab-item" id="home-tab-item-all">
                    <a id="home-tab-item-all-link" href="{{route('admin.supplier.index')}}" style="padding:18px">Tất
                        cả</a>
                    <span>{{$count[0]}}</span>
                </div>
                <div class="home-tab-item" id="home-tab-item-active">
                    <a id="home-tab-item-active-link" href="{{route('admin.supplier.index',['name'=>'active'])}}"
                        style="padding:18px">Đang hoạt
                        động</a>
                    <span>{{$count[1]}}</span>
                </div>
                <div class="home-tab-item" id="home-tab-item-hide">
                    <a id="home-tab-item-hide-link" href="{{route('admin.supplier.index',['name'=>'hide'])}} "
            ...
            <div class="layout-list-row layout-list-btn-wrap">
                    ...
                    <form method="POST" action="">
                        ...
                        <button type="submit" name="" value="" class="btn btn-success btn_hidden"
                            formaction="{{route('admin.supplier.active-supplier',['name'=>'hidden'])}}">Ẩn</button>
    
                        <button type="submit" name="" class="btn btn-success btn_hidden"
                            formaction="{{route('admin.supplier.active-supplier',['name'=>'show'])}}">Hiện</button>
    
                        <button type="submit" name="" class="btn btn-success btn_hidden" formaction="">Xóa</button>
    
                        <!-- thêm danh mục -->
                        <button class="btn_add">
                            <a class="btn btn-success" href="{{route('admin.supplier.create')}}">Thêm nhà cung cấp</a>
                        </button>
            </div>
